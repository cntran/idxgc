...
jQuery(document).ready(function($) {
  ...
  if ($("#region").length && $("#region").val() != "") {
    $(".list_area").hide();
    if ($("#state").length && $("#state").val() !== "")
      $("#list_area_" + getSlug($("#state").val()) + "_" + getSlug($("#region").val())).show();
    else
...
var idxgc = {	
	...
	// Tracking Class
	"tracking" : {
		"listingView" : function (listingId) {
			var iframe = document.createElement('iframe');
      iframe.src = 'http://idx-gamechanger.herokuapp.com/clients/view_listing/?listing_id=' + listingId;
...
function initMapWithListings(results) {
  loadedViewport = window.location.hash;
